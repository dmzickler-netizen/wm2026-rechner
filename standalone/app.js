...
(function () {
  ...
  var T = {
    de: {
      ...
      verdictSafe: 'Sicher weiter (mind. Platz 2)', verdictOut: 'Ausgeschieden', verdictNoData: 'Keine Daten',
    ...
    en: {
      ...
      verdictSafe: 'Through for sure (at least 2nd)', verdictOut: 'Eliminated', verdictNoData: 'No data',
    ...
    es: {
      ...
      verdictSafe: 'Clasificado seguro (mín. 2.º)', verdictOut: 'Eliminado', verdictNoData: 'Sin datos',
  ...
  function renderDerived(){
    ...
    renderStandings(standings); renderThirds(thirds); renderMyTeam(standings,thirds); renderOpponents(standings,thirds)
  }
  ...
  function renderHeader(){
    ...
    el('myTeam').addEventListener('change',function(){ ui.myTeam=this.value; renderDerived() })
